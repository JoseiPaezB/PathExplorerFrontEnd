          ...
          <Card className="overflow-hidden border-none shadow-card hover:shadow-elevated transition-all duration-300">
            ...
            <CardContent className="px-6 pb-2">
              <div className="space-y-4">
                {[
                  {
                    title: "Fecha límite de curso",
                    description: 
                      coursesInProgress.length > 0 
                        ? `Finalización de ${coursesInProgress[0]?.nombre}`
                        : "Finalización de curso en progreso",
                    date: "15/06/2025",
                    icon: Calendar,
                  },
                  {
                    ...
                    description: 
                      activeCertifications.length > 0 
                        ? `Renovar ${activeCertifications[0]?.nombre}`
                  ...
                  },
                  {
                    ...
                    description: 
                      employeeProyect && employeeProyect.length > 0
                        ? `Revisión de ${employeeProyect[0].nombre}`
                        : "Revisión de proyecto actual",
                    date: "30/05/2025",
                    icon: FileText,
                  },
                ].map((event, index) => (
                  ...
                  >
                    <div className="mt-0.5 rounded-full p-2 flex items-center justify-center text-primary">
